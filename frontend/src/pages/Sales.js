...
function Sales() {
  ...
  useEffect(() => {
    // Dummy products
    const dummyProducts = [
      { _id: "p1", name: "Arduino Uno" },
      { _id: "p2", name: "LM358" },
    ];

    // Dummy stores
    const dummyStores = [
      { _id: "s1", name: "Main Lab" },
      { _id: "s2", name: "R&D Store" },
    ];
    ...
    const dummySales = [
      {
        _id: "sale1",
        ProductID: { name: "Arduino Uno" },
        StoreID: { name: "Main Lab" },
        StockSold: 5,
        SaleDate: "2025-08-02T00:00:00.000Z",
        TotalSaleAmount: 2500,
      },
      {
        _id: "sale2",
        ProductID: { name: "LM358" },
        StoreID: { name: "R&D Store" },
        StockSold: 10,
        SaleDate: "2025-08-01T00:00:00.000Z",
        TotalSaleAmount: 800,
      },
    ];
